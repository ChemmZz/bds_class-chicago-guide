/* ============================================================
   CHICAGO GUIDE — V25 Pilsen Theme Enhanced
...
const SPOTS = [
  ...
  /* ── Thrift spots ─────────────────────────────────────── */
  {
    ...
    tags: ["thrift"],
    description: "Chicago's most revered used vinyl shop. Three floors of obsessively curated LPs — jazz, punk, soul, electronic. The staff picks are consistently sharper than most critics.",
    tip: "Check the dollar bins in back. Regulars find first pressings in there.",
    color: "var(--color-tag-thrift)"
  },
  {
    id: "village-discount",
    ...
    tags: ["thrift"],
    description: "Chicago's mega-thrift. Immense, slightly chaotic, endlessly rewarding. Priced by weight in some sections. The furniture and housewares floor yields mid-century finds at 1990s prices.",
  ...
  },
  {
    ...
    tags: ["thrift"],
    description: "One of Chicago's largest antique markets — 75+ dealers across two floors. Strong on 20th-century decorative arts, architectural salvage, and vintage lighting. A serious destination.",
  ...
  },
  {
    ...
    tip: "Pair with coffee at the Kopi Café a block away. Good afternoon loop.",
    color: "var(--color-tag-thrift)"
  },
  {
    id: "lost-eras",
...
function updateMap(orderedSpots) {
  ...
  orderedSpots.forEach((spot, i) => {
    const colorHex = resolveSpotColorHex(spot);
    const lightTags = new Set(["jazz", "cafe", "architecture"]);
